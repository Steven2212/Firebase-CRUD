...
const FirestoreGetdata = () => {
  ...
  const agequery = query(usersCollectionref, where("age","<",50))
...
//Using onSnapshot we can see realtime changes in our database when we make an update.

  //   onSnapshot(await agequery,(data)=>{
